...
\Cref{fig:higgsino_spectrum} shows the compressed mass spectrum of a representative \gls{pmssm} model point with higgsino-like $\lsp$, a model that the \onelepton search is not expected to be sensitive to.

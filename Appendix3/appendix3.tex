...
\Cref{fig:limitations_simplied_compressed,fig:limitations_simplied_stop1l} highlight the limitations of the simplified likelihood approach using the ATLAS compressed and stop searches.

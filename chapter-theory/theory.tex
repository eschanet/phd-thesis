...
\begin{equation}
	...
	\end{pmatrix},
\end{equation}
and have a total of eight degrees of freedom, three of which are used up to give masses to the $W^\pm$ and $Z$ bosons (see \cref{sec:ssb}). Thus, a total of five physical Higgs bosons appear in the MSSM; two neutral Higgs bosons even under CP transformation called $h^0$, one neutral Higgs boson odd under CP transformation called $A^0$ and finally two charged Higgs bosons called $H^\pm$. The two Higgs doublets $H_u$ and $H_d$ each get a VEV, named $v_u$ and $v_d$ respectively, that are connected to the VEV $v$ of the SM Higgs field by $	v_u^2 + v_d^2 = v^2$. Phenomenologically, the ratio of the two VEVs is usually considered, conventionally called $\tan{\beta}$,
\begin{equation}
	\tan{\beta} = \frac{v_u}{v_d}.
\end{equation}

Due to electroweak symmetry breaking, the fields in the MSSM are in general not mass eigenstates but instead
The two charged higgsinos mix with the two charged winos to form four charged mass eigenstates called \textit{charginos} ($\tilde{\chi}_1^\pm$, $\tilde{\chi}_2^\pm$, ordered with increasing mass) and the photino, zino and bino mix with the remaining neutral higgsinos to form four neutral mass eigenstates called \textit{neutralinos} ($\tilde{\chi}_1^0$, $\tilde{\chi}_2^0$, $\tilde{\chi}_3^0$, $\tilde{\chi}_4^0$, again ordered with increasing mass).

\improvement{mixing of squarks and sfermions}

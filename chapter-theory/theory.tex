...
\begin{align}
	\Delta m_h^2 = -\frac{\lambda_f^2}{8\uppi^2} \Lambda^2 + \dots\, .
...
\begin{align}
	\Delta m_h^2 = \frac{\lambda_S}{16\uppi^2}\Lambda^2 + \dots\, .
...
%\begin{align}
%	\Delta m_h^2 = \frac{\lambda_S}{16\uppi^2}\left[\Lambda^2 - 2m_S^2\ln\left(\Lambda/m_S\right)+ \dots\right].
%	\label{eq:scalar_correction}
%\end{align}

...
\begin{equation}
	...
	\end{pmatrix},
\end{equation}
and have a total of eight degrees of freedom, three of which are used up to give masses to the $W^\pm$ and $Z$ bosons (see \cref{sec:ssb}). Thus, a total of five physical Higgs bosons appear in the MSSM; two neutral Higgs bosons even under CP transformation called $h^0$, one neutral Higgs boson odd under CP transformation called $A^0$ and finally two charged Higgs bosons called $H^\pm$.
...
Another option is a neutralino LSP. In large portions of the MSSM parameter space, a neutralino LSP produces a DM relic density that is compatible with the DM relic density measured by Planck~\cite{Ellis:1983ew, Aghanim:2018eyx}. In the following, only neutralino LSPs are considered.

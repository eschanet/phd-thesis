...
\subsection{Mathematical description}\label{sec:susy_mathematical_description}

A generator of supersymmetric transformations is an operator that turns fermionic states $\ket{f}$ into bosonic states $\ket{b}$ and vice-versa.


\subsection{R-parity}\label{sec:rparity}

\subsection{Supersymmetry breaking}\label{sec:susy_breaking}

...
\begin{figure}
	...
	\begin{subfigure}[b]{0.245\linewidth}
		\centering\includegraphics[width=0.9\textwidth]{qed_anomalous_moment}
		\caption{\label{fig:qed_anomalous_moment}}
	\end{subfigure}%
	\begin{subfigure}[b]{0.245\linewidth}
		\centering\includegraphics[width=0.9\textwidth]{qed_anomalous_moment}
		\caption{\label{fig:qcd_anomalous_moment}}
	\end{subfigure}%
	\begin{subfigure}[b]{0.245\linewidth}
		\centering\includegraphics[width=0.9\textwidth]{qed_anomalous_moment}

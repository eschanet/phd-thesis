...
The last of the optimisation methods, used in the following, relies on scans over sets of simplified log-likelihood fit configurations in order to run a simplified version of the full statistical inference machinery on a large number of signal region candidates.

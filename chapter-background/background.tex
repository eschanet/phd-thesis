...
The contributions from $\ttbar$, $\wjets$ production and single top processes are normalised to data in dedicated \glspl{cr}. 

\subsection[Control regions for $\ttbar$]{Control regions for $\boldsymbol{\ttbar}$}

\subsection{Control region for single top}

\subsection[Control region for $\wjets$]{Control regions for $\boldsymbol{\wjets}$}

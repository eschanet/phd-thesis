...
{\textbf{ VR channel}}           & VRtt1offEl            & VRtt2offEl            & VRtt3offEl              \\[-0.05cm]
\noalign{\smallskip}\hline\noalign{\smallskip}
%%
...
\end{center}
\caption{ Background fit results for the VRtt1offEl\_cuts, VRtt2offEl\_cuts and VRtt3offEl\_cuts region(s),  for an integrated luminosity of $140.5$~\ifb.

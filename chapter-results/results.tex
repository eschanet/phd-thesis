...
\input{chapter-results/Figs/MyTable1LepSRMerge_bkgonly_sum.tex}
 ...
 \begin{figure}
	...
	\caption{Representative distribution shown in each exclusion signal region after the background-only fit. The shaded region includes all systematic uncertainties (including correlations) as well as \gls{mc} statistical uncertainties. Figures adapted from \reference\cite{SUSY-2019-08}.}

...
At the time of writing, the limits derived in this analysis constitute the most stringent limits on the $\charg\neutr\rightarrow Wh\lsp\lsp$ simplified model set by ATLAS\improvement{citation}. Although this is ultimately bound to change with new searches extending these limits even further, 

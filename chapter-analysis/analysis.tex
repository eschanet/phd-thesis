...
An exemplary diagram for a $\wjets$ event is illustrated in~\cref{fig:wjets}.\improvement{what slices?}
...
Similar to offline analysis, the trigger algorithms need to infer the $\etmiss$ from the momenta of the visible particles, while also having to satisfy the stringent event rate constraints set by the high-luminosity environment of the \gls{lhc}.

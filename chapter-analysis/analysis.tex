...
\improvement{table with obj def somewhere}
...
Even after the subtraction of pileup effects, some pileup jets still remain. The \gls{jvt}~\cite{PERF-2014-03}, a multivariate discriminant, can be used to suppress pileup jets. The \gls{jvt} uses variables that describe the fraction of the total jet momentum corresponding to tracks associated to the primary vertex. 


topo cluster~\cite{JetCellClustering:2016upy}
JES~\cite{PERF-2016-04,Aad:2020flx}
antikt~\cite{Cacciari:2008gp}
fastjet~\cite{Fastjet,Cacciari:2006sm}

...
Current plans foresee\footnote{The \gls{lhc} schedule recently had to be changed due to the COVID-19 pandemic~\cite{schedule}.} Run~3 to deliver about $\SI{200}{\per\femto\barn}$ of $pp$ collision data with centre-of-mass energies of $\SI{13}{\TeV}$ and $\SI{14}{\TeV}$.
